...
export const getTutorialMessage = () => (
  <div>
    ...
    <ol>
      ...
      <li><strong>Image generation:</strong> Based on the music analysis, AUDIXEL generates an image. The visual elements of the image are influenced by the music's features. For example, a high-energy song might produce vibrant, dynamic visuals, while a calm, soothing track might result in a more subdued, relaxed pattern.</li>
      <li><strong>Customisation:</strong> You can tweak various settings to customise the generated image. Adjust the amount of pixel sorting, change the angle of the visual elements, and select different sorting modes (like brightness, hue, or saturation) to get the perfect result you're looking for.</li>
