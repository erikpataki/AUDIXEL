...
export const getTutorialMessage = () => (
  <div>
    ...
    <ol>
      ...
      <li><strong>Customisation:</strong> You can tweak various settings to customise the generated image. Adjust the amount of pixel sorting, change the angle of the visual elements, and select different sorting modes (like brightness, hue, or saturation) to get the perfect look.</li>
