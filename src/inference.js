import { TensorflowMusiCNN } from './lib/essentia.js-model.umd.js';
import * as tf from './lib/tf.min.3.5.0.js';
import './lib/tf-backend-wasm-3.5.0.js';
...
function initModel() {
    model = new TensorflowMusiCNN(tf, getModelURL(modelName));
